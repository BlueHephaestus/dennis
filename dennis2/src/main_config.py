...
#This one will be for testing randomly different configs or seeing if some combinations are ideal
output_title="general testing"
output_filename="general_testing"
print_results = False
update_output = True
graph_output = True
