import dennis2_dev
from dennis2_dev import Network
from dennis2_dev import sigmoid, tanh, ReLU, ConvPoolLayer, FullyConnectedLayer, SoftmaxLayer

#import sample_loader

training_data, validation_data, test_data = dennis2_dev.load_data_shared(filename="../data/mnist.pkl.gz")
#training_data, validation_data, test_data = dennis2_dev.load_data_shared(filename="../data/samples.pkl.gz", normalize_x=True)
#training_data, validation_data, test_data = dennis2_dev.load_data_shared(filename="../data/expanded_samples.pkl.gz", normalize_x=True)
