...
#training_data, validation_data, test_data = sample_loader.loadd
...
'''
net = Network([
    FullyConnectedLayer(n_in=28*28, n_out=100),
...
net.SGD(training_data, 1000, mini_batch_size, .1, validation_data, test_data, momentum_coefficient=0.0, lmbda=.01)
'''
    ConvPoolLayer(image_shape=(mini_batch_size, 1, 289, 289), 
        filter_shape=(20, 1, 35, 35),#289-35 = 254
        subsample=(2, 2),#254/2 = 127+1 = 128
