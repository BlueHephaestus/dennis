...
class Configurer(object):
    def __init__(self, run_count, epochs):
        ...
        #Our default values
        self.output_types = 4#DON'T FORGET TO UPDATE THIS WITH THE OTHERS
        ...
        self.output_training_cost=True
        self.output_training_accuracy=True
        self.output_validation_accuracy=True
        self.output_test_accuracy=True
